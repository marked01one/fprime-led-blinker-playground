...
namespace Components {
  ...
  {
    // Variable to represent the command response
    auto cmdResp = Fw::CmdResponse::OK;

    // Verify if `on_off` is a valid argument.
    // Note: isValid is an autogenerated helper functions for enum
    if (!on_off.isValid())
    {
      // Log invalid argument event
    ...
    else
    {
      ...
      // Log the state we set to blinking.
